...
void testFormAndBureaucrat() {
	...
	try {
		...
		std::cout << G("Form details:") << std::endl;
		std::cout << form << std::endl;

		// Attempting to sign the form
		std::cout << G("Attempting to sign the form...") << std::endl;
		bureaucrat.signForm(form);

		// Showing form details after signing
		std::cout << G("Form details after signing:") << std::endl;
		std::cout << form << std::endl;
...
void testValidationAndGradeTooHighException() {
	try {
		...
		std::cout << Y("----- Testing validation and GradeTooHighException -----") << std::endl;
		std::cout << G("Attempting to create a form with invalid grade...") << std::endl;
